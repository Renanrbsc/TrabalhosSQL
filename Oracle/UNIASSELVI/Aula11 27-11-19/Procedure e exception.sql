CREATE OR REPLACE PROCEDURE proced_teste is
cursor c1 is 
select **** 
from employees e;
Begin
...
begin
select first_name into v_nome_gerente from employees
where employee_id = r1.manager_id;
excpetions when_no_data found then
v_nome_gerente:= 'Sem nome';
end;

insert into proc_teste (codigo,sobrenome) values ( , r1.sobrenome,v_nome_gerente);
end loop;
end proced_teste;
